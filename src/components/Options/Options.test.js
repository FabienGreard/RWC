...
describe('Options', () => {
  ...
  it('renders Options without crashing', () => {
    shallow(<Options options={options} handleOptionsChange={handleOptionsChange}/>);
  });

  it('Options has changed', () => {
    const wrapper = shallow(<Options options={options} handleOptionsChange={handleOptionsChange}/>);
  ...
  it('options has been checked', () => {
    ...
    const wrapper = mount(<Options options={options} handleOptionsChange={handleOptionsChange}/>);
